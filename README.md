...
### Option 4: Local Agent Matchmaker (browse and rank)

Run a small local UI to search the catalog, filter by division, and rank agents (offline heuristics or optional Gemini). See [agent-matchmaker/README.md](agent-matchmaker/README.md), [agent-matchmaker/GOALS.md](agent-matchmaker/GOALS.md), and [agent-matchmaker/RECOMMENDED_AGENTS.md](agent-matchmaker/RECOMMENDED_AGENTS.md).
...
- **Local Agent Matchmaker** — shipped: [agent-matchmaker/README.md](agent-matchmaker/README.md) (offline + optional smart match)
- Multi-agent workflow examples -- see [examples/](examples/)
